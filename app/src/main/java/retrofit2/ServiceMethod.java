...
final class ServiceMethod<R, T> {
     ...
     * This requires potentially-expensive reflection
     * so it is best to build each service method only once and reuse it. Builders cannot be reused.
     */
    static final class Builder<T, R> {
        ...
        private CallAdapter<T, R> createCallAdapter() {
            //  getGenericReturnType():获取返回值类型，如为泛型类型，则打印出类型信息.
